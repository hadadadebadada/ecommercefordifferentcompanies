...
class Craftsman(models.Model):
    ...
    branch = models.CharField(choices=CRAFTSMAN_CHOICES, max_length=1)
...
class Order(models.Model):
    ...
    def shipping(self):
        ...
        + boolean digital bei item setzten
        sonst dennis ivy min 43 part 3
